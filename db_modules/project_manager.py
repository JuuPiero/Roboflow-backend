...
class ProjectManager:
    ...
    def create_project(self, request_form):
        ...
        # DBController().execute_query("INSERT INTO versions (project_id) VALUES (?)", (new_project_item_id,))
    ...
    def push_value_by_id(self, project_id, classes):
        ...
        classes = json.loads(project['classes']) + classes
    ...
    #     project_info = self.project_table.find_one({'_id': ObjectId(project_id)})
    ...
    def get_all_projects(self, user_id):
        ...
        return projects
        # return [{**project, '_id': str(project['project_id']), 'user_id': str(project['user_id'])} for project in projects]